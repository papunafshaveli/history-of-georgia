export { default as CustomSplashScreen } from "./custom-splash-screen/CustomSplashScreen";
export { default as StartGameScreen } from "./start-game-screen/StartGameScreen";
